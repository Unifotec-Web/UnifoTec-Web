...
export const conceptProjects = [
  {
    ...
    image: "/images/projects/business-operations.webp",
    imageAlt: "Concept interface on a desktop monitor showing customer records, billing, payment activity, and reporting.",
  },
  {
    ...
    image: "/images/projects/retail-inventory.webp",
    imageAlt: "Concept point-of-sale and inventory interface on a tablet showing products, sales, stock levels, and checkout activity.",
  },
  {
    ...
    image: "/images/projects/mobile-service.webp",
    imageAlt: "Concept mobile application interface on three smartphones showing onboarding, an account dashboard, and service activity.",
  },
] as const;
